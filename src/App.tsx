...
// Lazy load every page — reduces initial bundle by ~70%
...
function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6">
      ...
      <a href="/" className="px-6 py-3 glass rounded-xl text-gold font-serif text-sm hover:bg-gold/10 transition-all">
        Вернуться домой
      </a>
    </div>
  )
